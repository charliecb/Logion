...
print(f"Beginning report build with parameters:")
...
# Generate data split
data_split = data # List of paragraphs in appropriate data split: in this case, the entire data because it is only a sample.
